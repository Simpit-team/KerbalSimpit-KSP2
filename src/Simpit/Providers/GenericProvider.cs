...
namespace Simpit.Providers
{
    ...
    */
    ...
    public abstract class GenericProvider<MsgType> : MonoBehaviour
    {
        ...
        private EventDataObsolete<byte, object> _msgChannel;
        ...
        {
            SimpitPlugin.AddToDeviceHandler(MsgProvider);
            _msgChannel = GameEvents.FindEvent<EventDataObsolete<byte, object>>("toSerial" + _channelID);
            GameEvents.FindEvent<EventDataObsolete<byte, object>>("onSerialChannelForceSend" + _channelID).Add(forceSending);
        }

        public void OnDestroy()
        {
            SimpitPlugin.RemoveToDeviceHandler(MsgProvider);
        }
